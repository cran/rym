...
* Загрузка оффлайн конверсий
    * `rym_switch_on_offline_conversion()` - Включить учёт оффлайн конверсий
    * `rym_switch_off_offline_conversion()` - Выключить учёт оффлайн конверсий
...
* Загрузка звонков
    * `rym_switch_on_calls()` - Включить учёт звонков
    * `rym_switch_off_calls()` - Выключить учёт звонков
